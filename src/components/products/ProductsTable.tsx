...
export default function ProductsTable() {
  const { data: products, total, getData: getProducts, addProduct, editProduct, deleteProduct } = useProducts();
            ...
            <TableBody>
              {products?.map((product) => (
                <StyledTableRow key={product?._id}>
                  ...
                  <StyledTableCell align="right">{product?.category?.name || "Category"}</StyledTableCell>
